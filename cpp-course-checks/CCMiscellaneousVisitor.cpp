...
bool CCMiscellaneousVisitor::VisitCXXConstCastExpr(clang::CXXConstCastExpr * cc_expr)
{
...
bool CCMiscellaneousVisitor::VisitCXXConstructorDecl(clang::CXXConstructorDecl * ctor_decl)
{
...
bool CCMiscellaneousVisitor::VisitDeclRefExpr(clang::DeclRefExpr * decl_ref)
{
...
bool CCMiscellaneousVisitor::VisitVarDecl(clang::VarDecl * var_decl)
{
...
bool CCMiscellaneousVisitor::VisitFunctionDecl(clang::FunctionDecl * func_decl)
{
...
bool CCMiscellaneousVisitor::VisitCompoundStmt(clang::CompoundStmt * comp_stmt)
{
...
bool CCMiscellaneousVisitor::dataTraverseStmtPost(clang::Stmt * stmt)
{
...
void CCMiscellaneousVisitor::addAssigned(const clang::VarDecl * var_decl)
{
...
void CCMiscellaneousVisitor::removeAssigned(const clang::VarDecl * var_decl)
{
...
const clang::Stmt * CCMiscellaneousVisitor::currCtor() const
{
