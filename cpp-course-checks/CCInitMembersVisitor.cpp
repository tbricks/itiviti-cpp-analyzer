...
CCInitMembersVisitor::CCInitMembersVisitor(clang::CompilerInstance & ci, const ICAConfig & checks)
...
bool CCInitMembersVisitor::VisitCXXOperatorCallExpr(clang::CXXOperatorCallExpr * op_call)
{
...
bool CCInitMembersVisitor::VisitBinaryOperator(clang::BinaryOperator * op_call)
{
    if (!(shouldProcessExpr(op_call, getSM()) && m_curr_ctor_body)) {
        return true;
    }
...
bool CCInitMembersVisitor::VisitMemberExpr(clang::MemberExpr * member)
{
...
bool CCInitMembersVisitor::VisitCXXConstructorDecl(clang::CXXConstructorDecl * ctor_decl)
{
...
bool CCInitMembersVisitor::dataTraverseStmtPost(clang::Stmt * stmt)
{
...
void CCInitMembersVisitor::addToReport(const clang::MemberExpr * member)
{
...
void CCInitMembersVisitor::foundMember(const clang::MemberExpr * member)
{
...
void CCInitMembersVisitor::checkAssignment(const clang::Expr * lhs, const clang::Expr * rhs)
{
