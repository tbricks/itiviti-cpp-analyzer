...
CCReturnValueVisitor::CCReturnValueVisitor(clang::CompilerInstance & ci, const ICAConfig & checks)
...
bool CCReturnValueVisitor::VisitFunctionDecl(clang::FunctionDecl * func_decl)
{
...
bool CCReturnValueVisitor::VisitReturnStmt(clang::ReturnStmt * return_stmt)
{
...
bool CCReturnValueVisitor::dataTraverseStmtPost(clang::Stmt * stmt)
{
