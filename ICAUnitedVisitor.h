...
class ICAUnitedVisitor : public clang::RecursiveASTVisitor<ICAUnitedVisitor<Visitors...>>
{
public:

    ICAUnitedVisitor(clang::CompilerInstance & ci, const ICAConfig & config) :
